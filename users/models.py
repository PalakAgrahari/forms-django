...
class Machine(models.Model):
    ...
    machine_Picture = models.ImageField(upload_to="images/machine", height_field=None, width_field=None,null=True, blank=True)
    pO_Copy = models.ImageField(upload_to="images/po_copy",null=True, blank=True)
